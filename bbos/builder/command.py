...
from builder import util, dir_util, file_util, archive_util, dep_util
from builder import log

class Command:
    """Abstract base class for defining command classes, the "worker bees"
    of the builder.  A useful analogy for command classes is to think of
    ...
    def dump_options (self, header=None, indent=""):
        from builder.fancy_getopt import longopt_xlate
        if header is None:
