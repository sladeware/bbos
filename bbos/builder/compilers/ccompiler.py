...
from builder.file_util import move_file
from builder.dir_util import mkpath
from builder.dep_util import newer_pairwise, newer_group
from builder.util import split_quoted, execute
...
def show_compilers():
    ...
    from builder.fancy_getopt import FancyGetopt
    compilers = []
...
def new_compiler (plat=None,
    ...
    try:
        module_name = "builder.compilers." + module_name
