...
class Network(networkx.MultiDiGraph):
    ...
    class Edge(object):
        ...
        each node is represented by :class:`bb.mapping.Mapping`. Each edge has a
        direction (from `sender` to `receiver`, or back and forth), plus a set
    ...
    def has_node(self, node):
        ...
        if not isinstance(node, bb.Mapping):
            raise TypeError("Has to be bb.Mapping")
