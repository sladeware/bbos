...
#define BB_STR(A1) _BB_DO_STR_CONVERT(A1)
#define _BB_DO_STR_CONVERT(A1) #A1

#define BB_STR_JOIN2(A1, A2) A1 ## A2
#define BB_STR_JOIN3(A1, A2, A3) A1 A2 A3

#define BB_PATH_JOIN2(A1, A2) A1/A2
#define BB_PATH_JOIN3(A1, A2, A3) BB_PATH_JOIN2(A1, BB_PATH_JOIN2(A2, A3))
