...
'	par	word     descr
'	----------------------
'	+2	pbase    the starting address of an object
'	+4	vbase    the starting address of the VAR section of an object
'	+6	dbase    the starting address of a method's stack variables
'	+8	pcurr    the address of the next opcode to be executed
'	+A	dcurr    the address of the next variable to be stored on the stack
'
' Entry
'
DAT			org
