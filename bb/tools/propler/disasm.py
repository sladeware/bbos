...
__all__ = ["disasm_image", "disasm_image_file"]
...
(ASM_OP_NONE, ASM_OP_JMP, ASM_OP_RD_WR_HUB, ASM_OP_NOP,)=range(4)
...
def disasm_image_file(filename_or_stream):
    global _data
    global buffer
    global p
    global cog_p
