...
/**
 * asn1_read_struct - Reads data structure such as tag and length.
 * @pos:
 * @tag:
 * @len:
 */
...
/**
 * perm_decode - Converts PEM encoding to the binary DER form.
 * @in:
 * @out:
 * @out_len:
 * @type_str:
...
/**
 * asn1_init - Initializes an asn1_ctx_t.
...
/**
 * asn1_length - Gets the current length of the ASN.1 sequence.
 * @asn1_ctx: A pointer to asn1_ctx_t structure.
 *
 * Return value:
 *
...
/**
 * asn1_create_seq - Creates a ASN.1 sequence.
 * as the type.
 * @asn1_ctx:
 * @start:
 * @end:
...
/**
 * asn1_create_seq_tag - Creates a ASN.1 sequence of tag entry_tag. 
 * @asn1_ctx: A pointer to asn1_ctx_t structure.
 * @start: Pointer to the start of the sequence. Specify NULL to start at 
 * the beginning of the buffer.
 * @end: Pointer to the end of the sequence. Specify NULL to end at the end of 
 * the buffer.
 ...
 * Description:
 *
 * Shifts the bytes pointed to by start and end and prepend them with the type
 * and length.
 *
 * Example:
 *
...
/**
 * asn1_append_int_tag - Appends an integer to the end of a ASN.1 sequence of type tag.
 * @asn1_ctx: A pointer to asn1_ctx_t structure.
...
/**
 * asn1_append_int - Appends an integer to the end of an ASN.1 sequence of type 
 * ASN1_TAG_INTEGER.
 *
 * Return value:
 *
...
/**
 * asn1_append_timetick - Appends timeticks to the end of an ASN.1 sequence.
 * @asn1_ctx: A pointer to asn1_ctx_t structure.
...
/**
 * asn1_append_string - Appends a string to the end of an ASN.1 sequence.
 * @asn1_ctx: A pointer to asn1_ctx_t structure.
...
/**
 * asn1_append_oid - Appends an OID to the end of an ASN.1 sequence.
 * @asn1_ctx: A pointer to asn1_ctx_t structure.
...
/**
 * asn1_read_tag - Reads the ASN.1 tag from an ASN.1 sequence.
...
/**
 * asn1_read_length - Reads the ASN.1 length from an ASN.1 sequence.
 * @pos: Pointer to the position in the ASN.1 sequence.
...
/**
 * asn1_read_string - Reads the ASN.1 string from an ASN.1 sequence.
 * @pos: Pointer to the position in the ASN.1 sequence.
...
/**
 * asn1_read_int - Reads the ASN.1 int from an ASN.1 sequence.
 * @pos: Pointer to the position in the ASN.1 sequence.
...
/**
 * asn1_read_oid - Reads the ASN.1 oid from an ASN.1 sequence. 
 * @pos: Pointer to the position in the ASN.1 sequence.
...
/**
 * asn1_calc_oid_length - Calculates the length of an oid string in bytes.
 * @oid:
 *
 * Return value:
 *
...
/**
 * asn1_write_long - Writes a long value to the ASN.1 sequence.
 * @asn1_ctx:
 * @out:
 * @val:
 *
