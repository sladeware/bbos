...
import bbos.crypto.asn1 as asn1
...
class PKCS1v15Encryption(RSAEncryptionScheme):
...
def rsa_gen_key(k):
  ...
  return RSAPublicKey(n, e), \
      RSAPrivateKey(n, e, p, q, d, d_p, d_q, q_inv)
